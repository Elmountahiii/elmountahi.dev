...
import { Github, Mail, Code2, Terminal, Database, ExternalLink } from "lucide-react";
				...
				<div className="flex flex-col lg:flex-row gap-16">
					...
					<div className="flex-1 space-y-8">
						...
						<div className="prose prose-invert prose-lg text-zinc-400 leading-relaxed font-light">
							<p>
								I've been coding for over <span className="text-white font-medium">5 years</span>, 
								starting my journey in 2020. What began as a simple curiosity about how the web works 
								has evolved into a passionate career building complex, scalable SaaS applications.
							</p>
							<p>
								My philosophy is simple: <span className="text-white font-medium">Solve real problems</span>. 
								I don't just write code; I architect solutions that prioritize performance, user experience, 
								and maintainability. From optimizing database queries to crafting 60fps animations, 
					...
					<div className="flex-1">
						<div className="bg-zinc-900/30 border border-white/5 rounded-3xl p-8 backdrop-blur-sm">
							...
							<div className="mt-8 pt-8 border-t border-white/5">
								<button type="button" className="inline-flex items-center gap-2 text-sm text-zinc-500 hover:text-white transition-colors cursor-pointer">
